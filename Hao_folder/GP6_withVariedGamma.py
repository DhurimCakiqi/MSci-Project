...
df=pd.read_excel('samples_para_stress_variedGamma.xlsx')
...
# kernel = ConstantKernel(100, (1e-3, 1e3))*RBF(length_scale= 10, length_scale_bounds=(0.0,100))
...
#kernel = ConstantKernel(100, (1e-3, 1e3))*RationalQuadratic(length_scale=10.0, alpha=0.1)
